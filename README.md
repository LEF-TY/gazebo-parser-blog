...
![Visualization of how Gazebo and FEAGI can work together, with a focus on the parsing of Gazebo SDF files](gazebo_feagi_flow.webp)
...
![Chart of sensors/input used by FEAGI](sensor_chart.webp)

Actuators use the input from the sensor or user (in this case, FEAGI) to complete actions (output).
![Chart of actuators/output used by FEAGI](actuator_chart.webp)
...
![Flowchart demonstrating the parsing process and how it will be used](detailed_parser_flow.webp)
...
![Robot successfully using camera sensor](gazebo_demo.mp4)
...
![Robot successfully being controlled through FEAGI's brain visualizer](gazebo_demo_2.mp4)
